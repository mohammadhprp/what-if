...
CacheModel _cacheModelDeserialize(
  ...
  object.expiredAt = reader.readDateTimeOrNull(offsets[0]);
  object.id = id;
...
extension CacheModelQueryFilter
  ...
  QueryBuilder<CacheModel, CacheModel, QAfterFilterCondition> expiredAtEqualTo(
      DateTime? value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CacheModel, CacheModel, QAfterFilterCondition> expiredAtLessThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CacheModel, CacheModel, QAfterFilterCondition> expiredAtBetween(
    DateTime? lower,
    DateTime? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<CacheModel, CacheModel, QAfterFilterCondition> valueIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'value',
      ));
  ...
  QueryBuilder<CacheModel, CacheModel, QAfterFilterCondition> valueIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'value',
      ));
  ...
  QueryBuilder<CacheModel, CacheModel, QAfterFilterCondition> valueEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CacheModel, CacheModel, QAfterFilterCondition> valueGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<CacheModel, CacheModel, QAfterFilterCondition> valueLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<CacheModel, CacheModel, QAfterFilterCondition> valueBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<CacheModel, CacheModel, QAfterFilterCondition> valueStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CacheModel, CacheModel, QAfterFilterCondition> valueEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CacheModel, CacheModel, QAfterFilterCondition> valueContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<CacheModel, CacheModel, QAfterFilterCondition> valueMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
...
extension CacheModelQuerySortBy
  ...
  QueryBuilder<CacheModel, CacheModel, QAfterSortBy> sortByExpiredAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'expiredAt', Sort.asc);
    });
  }

  QueryBuilder<CacheModel, CacheModel, QAfterSortBy> sortByExpiredAtDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CacheModelQuerySortThenBy
  ...
  QueryBuilder<CacheModel, CacheModel, QAfterSortBy> thenByExpiredAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'expiredAt', Sort.asc);
    });
  }

  QueryBuilder<CacheModel, CacheModel, QAfterSortBy> thenByExpiredAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'expiredAt', Sort.desc);
    });
  }
...
extension CacheModelQueryWhereDistinct
  ...
  QueryBuilder<CacheModel, CacheModel, QDistinct> distinctByExpiredAt() {
    return QueryBuilder.apply(this, (query) {
...
extension CacheModelQueryProperty
  ...
  QueryBuilder<CacheModel, DateTime?, QQueryOperations> expiredAtProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CacheModel, String?, QQueryOperations> valueProperty() {
    return QueryBuilder.apply(this, (query) {
